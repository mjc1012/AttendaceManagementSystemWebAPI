    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendanceLogStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceLogs_AttendanceLogStates_AttendanceLogStateId",
            ...
            migrationBuilder.InsertData(
                table: "AttendanceLogStates",
                columns: new[] { "Id", "Name" },
                values: new object[,]
                {
                    { 1, "Within Work Time" },
                    { 2, "Not Within Work Time" },
                    { 3, "N/A" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "AccessToken", "EmailAddress", "EmployeeIdNumber", "EmployeeRoleId", "FirstName", "LastName", "MiddleName", "Password", "ProfilePictureImageName", "RefreshToken", "RefreshTokenExpiryTime", "ResetPasswordExpiry", "ResetPasswordToken" },
                values: new object[] { 1, null, "Admin", "Admin", 1, "Admin", "Admin", null, "lHsgeMMQCKBRDLq/V6kAil1ow6cg33eP1m8bCgbEu8s=", "default_image.jpg", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null });
